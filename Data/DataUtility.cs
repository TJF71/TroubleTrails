            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2021,8,20).ToUniversalTime(), 
                         EndDate = new DateTime(2021,8,20).AddMonths(1).ToUniversalTime(),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2021,8,20).ToUniversalTime(),
                         EndDate = new DateTime(2021,8,20).AddMonths(4).ToUniversalTime(),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2021,8,20).ToUniversalTime(),
                         EndDate = new DateTime(2021,8,20).AddMonths(6).ToUniversalTime(),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2021,8,20).ToUniversalTime(),
                         EndDate = new DateTime(2021,8,20).AddMonths(2).ToUniversalTime(),
                         ProjectPriorityId = priorityLow
                     },
                    new Project()
                     {
                         ...
                         StartDate = new DateTime(2021,8,20).ToUniversalTime(),
                         EndDate = new DateTime(2021,8,20).AddMonths(3).ToUniversalTime(),
                         ProjectPriorityId = priorityHigh
                     }
                };
        ...
        public static async Task SeedDefautTicketsAsync(ApplicationDbContext context)
        {
            ...
            try
            {
                IList<Ticket> tickets = new List<Ticket>() {
                                //PORTFOLIO
                                new Ticket() {Title = "Portfolio Ticket 1", Description = "Ticket details for portfolio ticket 1", Created = DateTimeOffset.Now.ToUniversalTime().ToUniversalTime(), ProjectId = portfolioId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
